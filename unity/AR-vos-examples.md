...
# AR-vos - Image Trigger and SLAM AR Examples

## Overview

**AR-vos**, see [ar-vos.com](https://ar-vos.com), is an open source app that can do **geolocative**, **SLAM** and **image trigger** AR. It is part of the [**ARpoise**](https://arpoise.com/) (**A**ugmented **R**eality **p**oint **o**f **i**nterest **s**ervice **e**nvironment) open-source Augmented Reality platform.
