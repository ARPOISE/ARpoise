/*
 ...
 $Log: pblCgi.c,v $
 Revision 1.8  2026/04/25 20:29:18  peter
 ...
 */
  ...
  */
char* pblCgi_c_id = "$Id: pblCgi.c,v 1.8 2026/04/25 20:29:18 peter Exp $";
 ...
 */
char* pblCgiGetCookie(char* cookieKey, char* cookieTag)
{
...
{
	static char* tag = "pblCgiValueForIteration";
	
	if (!key)
	{
		pblCgiExitOnError("%s: null key not allowed!\n", tag);
	}
