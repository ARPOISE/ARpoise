...
HTML;
    ...
    public static function createLayerScreen($layerName)
    {
        ...
        $result .= sprintf("<tr><td>Layer title</td><td><input type=\"text\" name=\"layerTitle\" value=\"%s\" size=\"60\"></td></tr>\n", $layerProperties->layerTitle);
        ...
        $result .= sprintf("<tr><td>Redirect to url</td><td><input type=\"text\" name=\"redirectionUrl\" value=\"%s\" size=\"60\"></td></tr>\n", $layerProperties->redirectionUrl);
        $result .= sprintf("<tr><td>Redirect to layer</td><td><input type=\"text\" name=\"redirectionLayer\" value=\"%s\" size=\"60\"></td></tr>\n", $layerProperties->redirectionLayer);
        ...
        $result .= sprintf("<tr><td>No pois message</td><td><input type=\"text\" name=\"noPoisMessage\" value=\"%s\" size=\"60\"></td></tr>\n", $layerProperties->noPoisMessage);
    ...
    public static function createPOIScreen($layerName, $poi = NULL, $showLayer, $url)
    {
        ...
        $result .= sprintf("<form accept-charset=\"utf-8\" action=\"?layerName=%s&action=poi&poiID=%s\" method=\"POST\">\n", urlencode($layerName), urlencode($poi->id));
        //$result .= "<table class=\"poi\" style=\"width:100%\" >\n";
        ...
        $result .= sprintf("<tr><td>Title</td><td><input type=\"text\" name=\"title\" value=\"%s\" size=\"60\"></td></tr>\n", $poi->title);
        ...
        $result .= sprintf("<tr><td>Absolute altitude</td><td><input type=\"text\" name=\"alt\" value=\"%s\" size=\"12\"></td></tr>\n", $poi->alt);
        $result .= sprintf("<tr><td>Relative altitude</td><td><input type=\"text\" name=\"relativeAlt\" value=\"%s\" size=\"12\"></td></tr>\n", $poi->relativeAlt);

            $result .= sprintf("<tr><td>URL for asset bundle</td><td><input type=\"text\" name=\"baseURL\" value=\"%s\" size=\"60\"></td></tr>\n", $poi->object->baseURL);
            $result .= sprintf("<tr><td>Prefab name</td><td><input type=\"text\" name=\"full\" value=\"%s\" size=\"60\"></td></tr>\n", $poi->object->full);
            $result .= sprintf("<tr><td>Layer name</td><td><input type=\"text\" name=\"poiLayerName\" value=\"%s\" size=\"60\"></td></tr>\n", $poi->object->poiLayerName);
            $result .= sprintf("<tr><td>Relative location (x,y,z)</td><td><input type=\"text\" name=\"relativeLocation\" value=\"%s\" size=\"60\"></td></tr>\n", $poi->object->relativeLocation);
            $result .= sprintf("<tr><td>Scaling factor</td><td><input type=\"text\" name=\"scale\" value=\"%s\" size=\"10\"></td></tr>\n", $poi->transform->scale);
            $result .= sprintf("<tr><td>Vertical rotation</td><td><input type=\"text\" name=\"angle\" value=\"%s\" size=\"10\"></td></tr>\n", $poi->transform->angle);
            $result .= sprintf("<tr><td>Relative angle</td><td>%s</td></tr>\n", self::createCheckbox("rel", $poi->transform->rel));
            $result .= sprintf("<tr><td>URL for trigger image</td><td><input type=\"text\" name=\"triggerImageURL\" value=\"%s\" size=\"60\"></td></tr>\n", $poi->object->triggerImageURL);
            $result .= sprintf("<tr><td>Width of trigger image</td><td><input type=\"text\" name=\"triggerImageWidth\" value=\"%s\" size=\"10\"></td></tr>\n", $poi->object->triggerImageWidth);
        foreach ($poi->actions as $key => $action) {
    ...
    //        }
        ...
        if (! $layerAction)
        {
            $result .= "<table class=\"action\" style=\"width:100%\" >\n";
        ...
        else 
        {
            ...
            $result .= sprintf("<tr><td>Label</td><td><input type=\"text\" name=\"actions[%s][label]\" value=\"%s\" size=\"40\"></td></tr>\n", $index, $action->label);
            $result .= sprintf("<tr><td>Show information</td><td>%s</td></tr>\n", self::createCheckbox(sprintf("actions[%s][showActivity]", $index), $action->showActivity));
            $result .= sprintf("<tr><td>Information message</td><td><input type=\"text\" name=\"actions[%s][activityMessage]\" value=\"%s\" size=\"40\"></td></tr>\n", $index, $action->activityMessage);
            $result .= "</table>\n";
        }
    ...
    {
        $result = "";
        $result .= "<table class=\"animation\" style=\"width:100%\" >\n";
        $result .= sprintf("<tr><td>Name</td><td><input type=\"text\" name=\"animations[%s][name]\" value=\"%s\" size=\"40\"></td></tr>\n", $index, $animation->name);
        ...
        $result .= sprintf("<tr><td>Followed by</td><td><input type=\"text\" name=\"animations[%s][followedBy]\" value=\"%s\" size=\"40\"></td></tr>\n", $index, $animation->followedBy);
        $result .= "</table>\n";
    ...
    public static function createLoginScreen()
    {
        ...
        $result .= "<tr><td>Username</td><td><input type=\"text\" name=\"username\" size=\"25\"></td></tr>\n";
        $result .= "<tr><td>Password</td><td><input type=\"password\" name=\"password\" size=\"25\"></td></tr>\n";
