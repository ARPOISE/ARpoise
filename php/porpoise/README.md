...
The enhancement has been implemented with the releases done in August of 2021. If an animation with a name of **SetActive** or **SetInActive** is **started**, or an animation with such a **Followed by** value **ends**, the game object of the POI is set to active/inactive.
...
The enhancement has been implemented with the releases done in August of 2021.
