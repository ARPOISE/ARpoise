...
class XMLPOIConnector extends POIConnector {
    ...
    unset($simpleXML->action);
		...
		$relevantFields = array("bleachingValue", "refreshInterval", "areaSize", "areaWidth", "visibilityRange", "refreshDistance", "fullRefresh", "applyKalmanFilter", "showMessage", "redirectionLayer", "noPoisMessage");
